...
const findDoc = {
  type: v.union(v.literal("game"), v.literal("shader"), v.literal("inspiration"), v.literal("model_site")),
  title: v.string(),
  summary: v.string(),
  url: v.string(),
...
export const listByType = query({
  args: { type: v.union(v.literal("game"), v.literal("shader"), v.literal("inspiration"), v.literal("model_site")) },
